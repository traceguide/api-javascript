...
// Standard logging
traceguide.infof("Hello World!");
traceguide.warnf("Favorite number = %d", 42);
traceguide.errorf("Favorite things = %j", { animal : 'dolphin' });

// A contrived trace
var outer = traceguide.span("outer_operation");
